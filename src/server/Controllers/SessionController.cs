...
public class SessionController : ControllerBase
{
    ...
    public ActionResult<SessionSecretResponse> GenerateSecret([FromRoute] uint revision) =>
        new SessionSecretResponse(Guid.NewGuid().ToString());
