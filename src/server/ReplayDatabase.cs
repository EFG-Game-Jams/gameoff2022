...
public class ReplayDatabase : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PlayerEntity>()
            .HasIndex(e => e.ItchIdentifier)
            .IsUnique();
        modelBuilder.Entity<PlayerEntity>()
            .HasIndex(e => e.Name);

        modelBuilder.Entity<ReplayEntity>()
            .HasIndex(e => e.FileName)
            .IsUnique();
        modelBuilder.Entity<ReplayEntity>()
            .HasIndex(e => e.TimeInMilliseconds);
        modelBuilder.Entity<ReplayEntity>()
            .HasIndex(e => e.GameRevision);
        modelBuilder.Entity<ReplayEntity>()
            .HasIndex(e => new { e.PlayerId, e.LevelId, e.GameRevision })
            .IsUnique();
